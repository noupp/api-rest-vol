...
public class DevDatabases {
	...
	public DevDatabases() {
		...
		Flight flight0 = new Flight(0, places0, LocalDate.parse("2016-09-20"), "Marseille", "Paris");
		...
		Flight flight1 = new Flight(1, places1, LocalDate.parse("2016-09-20"), "Lyon", "Brest");
		...
		Flight flight2 = new Flight(2, places2, LocalDate.parse("2016-09-20"), "Paris", "Tokyo");
		...
		Flight flight3 = new Flight(3, places3, LocalDate.parse("2016-09-20"), "Seoul", "Beijing");
